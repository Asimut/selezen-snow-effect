 ...
 */
      ...
      (function() {
        ...
        function initSnowEffect(jQuery) {
            ...
            window.SnowEffect = {
                ...
                init: async function(scriptUrl) {
                    ...
                    // Завжди запускаємо або зупиняємо ефект після оновлення налаштувань
            ...
            // Ініціалізація та періодичне оновлення
        ...
        if (document.readyState === 'loading') {
            document.addEventListener('DOMContentLoaded', () => waitForJQuery(initSnowEffect));
        } else {
